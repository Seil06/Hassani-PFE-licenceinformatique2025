      ...
      child: BottomNavigationBar(
        ...
        onTap: (index) {
          setState(() {
            ...
            if (index == 0) {
              Navigator.pushReplacementNamed(context, RouteGenerator.home, arguments: {'userType': widget.userType});
            } else if (index == 1) {
              Navigator.pushReplacementNamed(context, RouteGenerator.profile); // Simplified to profile route
            } else if (index == 2) {
              Navigator.pushReplacementNamed(context, '/my-donations');
            } else if (index == 3) {

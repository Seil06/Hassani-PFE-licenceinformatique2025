...
class ProfileBeneficiaire extends StatelessWidget {
  ...
  Future<Map<String, dynamic>?> _getUserData() async {
    ...
    return await Supabase.instance.client
        .from('acteur')
        .select('beneficiaire(nom, prenom)')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Profil Bénéficiaire'),
        ...
        child: Padding(
          ...
          child: FutureBuilder<Map<String, dynamic>?>(
            ...
            builder: (context, snapshot) {
              ...
              final data = snapshot.data!['beneficiaire'];
              return Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.pushNamed(context, RouteGeneratorBeneficiaire.setting);
                    },

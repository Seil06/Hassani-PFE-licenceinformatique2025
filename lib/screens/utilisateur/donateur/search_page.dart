...
class SearchPageDonateur extends StatefulWidget {
  const SearchPageDonateur({super.key});

  @override
  State<SearchPageDonateur> createState() => _SearchPageDonateurState();
}

class _SearchPageDonateurState extends State<SearchPageDonateur> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Trouver un besoin'),
        centerTitle: true,
        actions: [
          Padding(
